...
describe('Linked List', function () {
    it('Inserting somewhere inside.', function () {
        ...
        chai_1.expect(getAllValues(testList.root, 4)).to.deep.equal([5, 6, 10, 8]);
    });
    it('Inserting in an empty list.', function () {
        var testList = new linked_list_1.default();
        testList.insert(10, 0);
        chai_1.expect(getAllValues(testList.root, 1)).to.deep.equal([10]);
    });
    it('Inserting after the last position.', function () {
        ...
        chai_1.expect(getAllValues(testList.root, 4)).to.deep.equal([5, 6, 8, 10]);
    });
    it('Inserting at a non-existent too high position.', function () {
        ...
        chai_1.expect(getAllValues(testList.root, 3)).to.deep.equal([5, 6, 8]);
    });
    it('Delete somewhere inside.', function () {
        ...
        testList.append(8);
        testList.delete(1);
        chai_1.expect(getAllValues(testList.root, 2)).to.deep.equal([5, 8]);
    });
    it('Delete at the start.', function () {
        ...
        testList.append(8);
        testList.delete(0);
        chai_1.expect(getAllValues(testList.root, 2)).to.deep.equal([6, 8]);
    });
    it('Delete at the end.', function () {
        ...
        testList.append(8);
        testList.delete(2);
        chai_1.expect(getAllValues(testList.root, 2)).to.deep.equal([5, 6]);
    });
});
