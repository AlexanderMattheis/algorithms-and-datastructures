...
describe('List Priority Queue', () => {
    ...
    it('Inserting elements.', () => {
        let nodes: GraphNode[] = TestHelpers.getFivePathNodes();
        let testQueue: ListPriorityQueue<GraphNode> = TestHelpers.fillQueue(nodes);
    ...
    it('Removing inside.', () => {
        ...
        testQueue.remove(new GraphNode(5, 6));
    ...
    it('Removing non-existent.', () => {
        ...
        testQueue.remove(new GraphNode(5,2));
    ...
    it("Testing 'contains'-operation.", () => {
        ...
        expect(testQueue.contains(new GraphNode(5,2))).to.equal(false);
