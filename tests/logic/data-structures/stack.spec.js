...
describe('Stack', function () {
    it('Adding too many elements.', function () {
        ...
        chai_1.expect(testStack.peek()).to.equal(null);
        // push 6 elements (too many!)
        testStack.push(1);
        chai_1.expect(testStack.peek()).to.equal(1);
        testStack.push(5);
        testStack.push(6);
        testStack.push(6);
        testStack.push(8);
        testStack.push(9);
        chai_1.expect(testStack.top).to.equal(5);
        chai_1.expect(testStack.peek()).to.equal(8);
    });
    it('Adding/Removing elements.', function () {
        ...
        // removing second
        value = testStack.pop();
        chai_1.expect(testStack.top).to.equal(0);
